...
driver.find_element_by_xpath('//*[@id="username"]').send_keys('15202458978')
driver.find_element_by_xpath('//*[@id="password"]').send_keys('126436xpk123')
