...
urlpatterns = [
    ...
    path('page/2003/', views.page_2003_view),  # 路由不包含/
    ...
    path('base_index/<int:m>', views.base_view, name='base_index'),
    ...
    re_path(r'^birthday/(?P<d>\d{1,2})/(?P<m>\d{1,2})/(?P<y>\d{4})$', views.birthday_view),
